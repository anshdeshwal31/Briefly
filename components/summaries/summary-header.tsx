...
import { MotionDiv, MotionH1, MotionSpan } from "../common/motion-wrapper";
...
export function SummaryHeader({
  ...
  return (
    <div className="flex gap-4 mb-4 justify-between">
      <MotionDiv variants={fadeInParent} initial="hidden" animate="show" className="space-y-6">
        <MotionDiv variants={fadeInUp} className="flex flex-wrap items-center gap-4">
          <Badge
            variant="secondary"
        ...
        <MotionH1 variants={fadeInUp} className="text-2xl lg:text-4xl font-bold lg:tracking-tight">
      ...
      <MotionDiv initial={{opacity:0,x:30}} animate={{opacity:1,x:0,transition:{delay:0.6}}} className="self-start">
        <Link href="/dashboard">
          ...
          >
            ...
            <MotionSpan className="text-xs sm:text-sm text-muted-foreground font-medium">
              Back{" "}
