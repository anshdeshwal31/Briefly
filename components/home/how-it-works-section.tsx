...
const steps: Step[] = [
 ...
 },
 {
   ...
   label: 'Get Summary',
   description: 'Recieve a concise, easy-to-read summary of your document',
 },
];
 ...
 return (
   <section className="relative overflow-hidden">
     ...
     <MotionDiv className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
       ...
       >
         <div
           className="relative left-[calc(50%-3rem)] aspect-video w-[36.125rem] -translate-x-1/2 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[calc(40%-30rem)] sm:w-[40.1875rem]"
           style={{
             clipPath:
